...
$url_path = str_replace('\\', '/', $url_path);
    ...
    $styles = $scss->compile('@import "1779.scss";');

    $css = fopen('css/1779.css','w');
...
<head>
    ...
    <link href="<?php echo $url_path ?>/css/1779.css" rel="stylesheet" type="text/css" />
