...
$url_path = str_replace('\\', '/', $url_path);
    ...
    $styles = $scss->compile('@import "1732.scss";');

    $css = fopen('css/1732.css','w');
...
<head>
    ...
    <link href="<?php echo $url_path ?>/css/1732.css" rel="stylesheet" type="text/css" />
